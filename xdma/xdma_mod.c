...
extern int zynq_probe(struct pci_dev *pdev, const struct pci_device_id *ent);
static int probe_one(struct pci_dev *pdev, const struct pci_device_id *id)
{
    ...
    // create_xcdev() -> cdev_ctrl_init() -> cdev_init()
...
extern void zynq_remove(struct pci_dev *pdev);
