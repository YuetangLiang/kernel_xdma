/**
 * [VC_CTL_Regisgter 0] 0x0001 0100
 * [VC_CTL_Regisgter 1] 0x0001 0200
 * [VC_CTL_Regisgter X] 0x0001 0X00
 *
 * zynq_rw /dev/zynq_gps 0x${VC_CTL_Regisgter} w
 * zynq_rw /dev/zynq_gps 0x${VC_CTL_Regisgter} w
 *
 */
#include <stdint.h>
